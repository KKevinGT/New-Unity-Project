...
namespace RockVR.Video.Editor
{
    ...
    public class VideoCaptureEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            videoCapture.stereoFormat = (VideoCapture.StereoFormat)EditorGUILayout.EnumPopup("Stereo Format", videoCapture.stereoFormat);
            if (videoCapture.stereoFormat != VideoCapture.StereoFormat.NONE)
            {
                videoCapture.stereoSeparation = EditorGUILayout.FloatField("Stereo Separation", videoCapture.stereoSeparation);
            }
